...
export default function RegisterScreen() {
  ...
  const [name, setName] = useLocalState("reg-name", "");
  const [email, setEmail] = useLocalState("reg-email", "");
  const [password, setPassword] = useLocalState("reg-password", "");
  const [errorMsg, setErrorMsg] = useLocalState("reg-error", "");
        ...
        <Card style={styles.card}>
          <Card.Content style={styles.cardContent}>
            ...
            <Text variant="bodyMedium" style={styles.subtitle}>
              Join Talksy to start chatting in real-time
            </Text>
